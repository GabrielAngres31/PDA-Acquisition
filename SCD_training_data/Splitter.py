...
def pickRandomImage(subfold):
    files = os.listdir("source_images\\generated\\base\\"+ subfold)
...
filenames = [pickRandomImage(sf) for sf in os.listdir("source_images\\generated\\base")] #os.listdir("source_images\\generated\\test\\base")
print(len(filenames))
...
DIR_SOURCE = "source_images\\generated"

...
def get_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type     = str, 
        required = True,
        help     = '''Path to .csv file containing pairs of input images to be used for training'''
    )
    parser.add_argument(
        '--validationsplit', 
        type     = str, 
        required = False,
        help     = '''Path to .csv file containing pairs of input images to be used for validation'''
    )
    parser.add_argument(
        '--patchsize',
        type    = int,

...
def main(args:argparse.Namespace) -> bool:
    ...
    # image_out = clean_image(image_in, args.prediction_type, args.filter_type, args.save_image_as)
    clean_image(image_in, args.prediction_type, args.filter_type, args.save_image_as)

    # Outline-based image workflow:
    
    
    # pd.DataFrame(image_out).to_csv(f"{args.output_folder}/{Path(args.input_path).stem}.csv")

def clean_image(image: PIL.Image, mode:str, filter_mode:str, saveas: str): #-> None

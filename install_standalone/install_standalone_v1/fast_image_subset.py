...
strangefiles = [
    "240x_1787y__MAX_BRXL2pBRXL2-YFP_ML1pmCherry-RCI2A_5dpg_120121_3_1_abaxial_merged_rotated-0002.tif",
...
strangestack = [
    "C:/Users/Gabriel/Documents/GitHub/PDA-Acquisition/only_pored/source_images/MAX_BRXL2pBRXL2-YFP_ML1pmCherry-RCI2A_5dpg_120121_3_1_abaxial_merged_rotated-0002.tif",
        ...
        for usestk_path in glob.glob(
            ...
            try:
                result = cv2.matchTemplate(
                    search_img, template_img, cv2.TM_CCOEFF_NORMED
                )
            except Exception:
            ...
            if max_val >= threshold:
                ...
                fl = True
                if os.path.basename(needle_path) == os.path.basename(usestk_path):
                    print(f"Whole File Detected: {os.path.basename(needle_path)}")
                else:
                    print(
                        f"Detected for {os.path.basename(needle_path)} within {os.path.basename(usestk_path)}"
                    )
            if fl:
                break
        if fl:

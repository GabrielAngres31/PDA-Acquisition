...
class StomataGUI:
    def __init__(self, root):
        ...
        assert os.path.exists("annotation_helper_files/stomata_gui_config.txt"), (
        ...
        with open(self.configFilePath, "r") as file:
            ...
            self.config_properties = dict(
                [(v for v in line.strip().split("=")) for line in lines]
            )
    ...
    def clean_inplace(self):  # CURRENTLY DOES NOT WORK!
        ...
        if np.unique(img).size != 2:
            ...
            cln_tbl = cf.quantify_clumps_skimage(
                cln_img,
                saveas=f"annotation_helper_files/{os.path.splitext(os.path.basename())[0]}.csv",
            )  # Run the Clumpfinder!!!  # noqa: F841
    ...
    def open_window_edit(self, event=None):
        ...
        canvas = image_audit_canvas_SUF_2.PixelCanvas(
            edit_root,
            window_size,
            window_size,

...
def main(args: argparse.Namespace) -> bool:
    ...
    vloss, _ = vloss_info["mean"], vloss_info["losses"]
    print(vloss)
    # print(vloss_all)
...
def get_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--model", type=str, required=True, help="""Path to model to validate."""
    )
    parser.add_argument(
        "--validationsplit",
        type=str,
    ...
    parser.add_argument(
        "--patchsize", type=int, default=128, help="Size of input patches in pixels"
    )
    parser.add_argument(
        "--cachedir",
        type=str,
